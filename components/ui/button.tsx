    ...
    return (
      <Comp className={cn(buttonVariants({ variant, effect, size, className }))} ref={ref} {...props}>
        {Icon &&
          iconPlacement === 'left' &&
          (effect === 'expandIcon' ? (
            <div className="w-0 max-w-0 opacity-0 transition-all duration-200 ease-in-out group-hover:max-w-[20px] group-hover:w-5 group-hover:opacity-100 group-hover:mr-2">
              <Icon />
            </div>
          ) : (
            <Icon />
        ...
        {Icon &&
          iconPlacement === 'right' &&
          (effect === 'expandIcon' ? (
            <div className="w-0 max-w-0 opacity-0 transition-all duration-200 ease-in-out group-hover:max-w-[20px] group-hover:w-5 group-hover:opacity-100 group-hover:ml-2">
              <Icon />
            </div>
          ) : (
            <Icon />
